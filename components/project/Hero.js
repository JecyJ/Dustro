...
const Hero = () => {
  return (
    <section className="relative w-full h-auto mb-10">
      ...
      <div className="relative w-48 md:w-72 p-3 top-1 sm:top-12 md:top-28 lg:top-48 left-64 sm:left-2/4 md:left-2/3 lg:left-2/3 bg-white border shadow-2xl border-t-4 border-t-[#D2153D]">

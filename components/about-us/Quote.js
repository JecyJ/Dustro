...
const Quote = () => {
  return (
    <section className="relative w-full h-auto md:h-screen my-20 md:my-0 md:mt-20">
        ...
        <div className="relative top-2 md:top-36 md:max-w-[800px] mx-auto text-center space-y-2">
        ...
        <div className="relative top-7 md:top-40 lg:top-80 grid grid-cols-2 md:grid-cols-3 max-w-[1000px] m-auto px-3 md:px-5">
            <div className="flex bg-white space-x-2 max-w-[220px]">
                ...
                <div>
                    ...
                    <p className="text-xs sm:text-sm lg:text-base">Etiam ac leo at quam aliquet</p>
                </div>
            </div>
            <div className="flex bg-white space-x-2 max-w-[220px]">
            ...
            <div className="hidden md:flex bg-white space-x-2 max-w-[280px]">
                ...
                <div>
                    <h2 className="text-[#00215B] font-bold">Kind Consultation</h2>
                    <p className="text-sm sm:text-sm lg:text-base">Etiam ac leo at quam aliquet</p>
                </div>
            </div>
        </div>
    </section>
